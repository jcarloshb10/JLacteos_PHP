                ...
                <div class="col-7 order-last" align="center" style="padding-top:20px;">
                    ...
                    <div class="container" style="background-color: rgb(248, 243, 241);">  
                            ...
                            <div id="ventana3" class='alert alert-success' role='alert'>
                                        ...
                                        <div>
                                            <h5 class="modal-title" style="color:blue;">Tu experiencia: </h5>
                                        </div>
                                        <div>
                                          <br>
                                        <?php
                                          ...
                                          if(!isset($_POST["text"])){
                                              ...
                                              sleep(4);
                                                ...
                                                echo "location = 'web_proveedor.php?user1=$correo_comp'";
                                                echo "</script>";
                                          }else{
                                              ...
                                              echo "<script>";
                                               echo "console.log('Cuantos ','$cuantos')";
                                                
                                                echo "</script>";
                                                
                                                echo "<script>";
                                               echo "console.log('Texto ','$texto')";
                                              ...
                                              if($texto == ""){
                                                ...
                                                //         echo "</script>";
                                                  ...
                                                  if($i==$cuantos){
                                                      ...
                                                      $sql_prop000 = "SELECT experiencia from persona where nombres like '$correo00'";
                                                      $resultt_prop000 = mysqli_query($bd_experiencia, $sql_prop000); 
                                                      $mostrar0000=mysqli_fetch_array($resultt_prop000); 
                                                      $exp_anterior = "".$mostrar0000['experiencia'];                                              
                                      
                                                      if($exp_anterior=="")
                                                      {
                                                        $sqll01 = "update persona set experiencia = '$lug_experiencia' where nombres like '$correo00'";
                                                        $resultt01 = mysqli_query($bd_experiencia, $sqll01); 
                                                      }
                                                      else{
                                                        
                                                        $sqll0 = "update persona set experiencia = concat('$exp_anterior','|','$lug_experiencia') where nombres like '$correo00'";
